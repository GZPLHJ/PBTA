# yolo task=detect mode=train model=null data=Citypersons/citypersons.yaml batch=5 epochs=900 imgsz=1280 workers=8 device=0 cos_lr=False lr0=0.01 lrf=0.2 warmup_epochs=3
# https://blog.csdn.net/weixin_45921929/article/details/128673338?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522168517341716800215023789%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=168517341716800215023789&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-1-128673338-null-null.142^v88^control_2,239^v2^insert_chatgpt&utm_term=yolov8%E8%AE%AD%E7%BB%83%E8%87%AA%E5%B7%B1%E7%9A%84%E6%95%B0%E6%8D%AE%E9%9B%86&spm=1018.2226.3001.4187
# yolo task=detect mode=train model=yolov8n.pt data=xfbd_yolo\xfbd.yaml batch=5 epochs=300 imgsz=1024 workers=8 device=0 cos_lr=True

# yolo task=detect mode=train model=yolov8n.pt data=xfbd_yolo\xfbd_aug.yaml batch=5 epochs=300 imgsz=1024 workers=8 device=0 cos_lr=True
...
class Loss:
    ...
    def __call__(self, preds, batch):
        ...
        # loss[1] = self.focal_loss(pred_scores, gt_labels).sum() / target_scores_sum  # focal
        # bbox loss
        if fg_mask.sum():
...
# F:\GuoZhoupeng\yolov8-o\ultralytics\yolo\v8\detect\train.py